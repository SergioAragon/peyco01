...
class Event extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'description'], 'match','pattern'=>"/^[a-z]+$/i",'message'=> 'Sólo se aceptan letras'],
            [['created_date', 'fin_evento'], 'match','pattern'=>"/^[0-9]+$/i",'message'=> 'Sólo se aceptan fechas con formato año/mes/día.'],
        ];
    }
